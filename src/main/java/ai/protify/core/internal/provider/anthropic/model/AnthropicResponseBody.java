...
public class AnthropicResponseBody {
    ...
    @ProtifyJsonProperty("stop_reason")
    private String stopReason;

    private AnthropicUsage usage;
    private List<AnthropicResponseContent> content;
    ...
    public List<AnthropicResponseContent> getContent() {
        return content;
    }

    public void setContent(List<AnthropicResponseContent> content) {
