...
public enum SupportedModel implements AIModel {
    ...
    GPT_5_4_MINI("gpt-5.4-mini", ProtifyAIProvider.OPEN_AI),
    O3("o3", ProtifyAIProvider.OPEN_AI),
    O4_MINI("o4-mini", ProtifyAIProvider.OPEN_AI),
    ...
    // xAI
    GROK_4_20("grok-4.20-0309-reasoning", ProtifyAIProvider.X_AI),
    GROK_4("grok-4", ProtifyAIProvider.X_AI),

    // Azure OpenAI
    GPT_5_4_AZURE("gpt-5.4", ProtifyAIProvider.AZURE_OPEN_AI),
    O4_MINI_AZURE("o4-mini", ProtifyAIProvider.AZURE_OPEN_AI),

    // Azure AI Foundry
    GPT_5_4_FOUNDRY("gpt-5.4", ProtifyAIProvider.AZURE_AI_FOUNDRY),
    ...
    AMAZON_NOVA_PREMIER_BEDROCK("amazon.nova-premier-v1:0", ProtifyAIProvider.AWS_BEDROCK),
